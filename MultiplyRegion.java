///////////////////////////////////////////////////////////////////////////////
// Title:            multiplyRegion
// Function:         used for all the regions where to operator is multiplication extends Region
// Semester:         Fall 2018
//
...
public class MultiplyRegion extends Region
{
    ...
    public MultiplyRegion(int tar, int val)
    /**
     * Constructor for Multiply region, calls super class Region
     */
    {
        super(tar, val);
    }
    ...
    /**
     * creates and returns a string representation of Multiply Region
